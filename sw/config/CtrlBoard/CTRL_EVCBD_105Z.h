// ================================================================================================
//! \file       CTRL_EVCBD_105Z.h
//! \brief      控制器EVCBD_105Z原理图
//! \author     sunyanjun
//! \version    1.0.0
//! \date       2017年4月12日
//! \copyright  SANTROLL.
...
#ifndef _CTRL_EVCBD_105Z_H_
#define _CTRL_EVCBD_105Z_H_

//! @defgroup CTRL_EVCBD_105Z
//! @{
...
#define CUR_RANGE        20000                      //!< 电流传感器满量程范围 0.1A ==> 800M(800A==>2V)
#define CURBUS_RANGE     0                          //!< 母线电流传感器满量程范围  0=没有母线电流传感器
#define VOLTBUS_RANGE    9257                       //!< 母线电压满量程范围     0.1V 可配置
#define VOLTCAP_RANGE    9257                       //!< 电容电压满量程范围     0.1V 可配置
...
//! @} // end of CTRL_EVCBD_105Z

#endif // end of _CTRL_EVCBD_105Z_H_
