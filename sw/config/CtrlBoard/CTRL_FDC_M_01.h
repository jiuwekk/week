...
// ================================================================================================
// the defines
#define USE_4C           0                          //!< 设置为1：使用4C外壳；为0：使用扁平控制器; 2:使用五合一
#define INVTEMP_TYPE     4                          //!< 逆变器温度采集 1：NTC473电路1 2:NTC473电路2 3:IGBT壳温（1。0倍） 4：IGBT壳温（1.5倍）
...
#define M1_VOLT_24V_RANGE  (41.52879612)  //!< 信号缺省时，配置为(24.0000)
