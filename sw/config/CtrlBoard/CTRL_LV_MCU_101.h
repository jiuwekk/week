// ================================================================================================
//! \file       CTRL_LV_MCU_101.h
//! \brief      控制器LV_MCU_101原理图
//! \author     sunyanjun
//! \version    1.0.0
//! \date       2017年4月12日
//! \copyright  SANTROLL.
...
#ifndef _CTRL_LV_MCU_101_H_
#define _CTRL_LV_MCU_101_H_

//! @defgroup CTRL_LV_MCU_101
//! @{
...
// ================================================================================================
// the defines
#define USE_4C           0                          //!< 设置为1：使用4C外壳；为0：使用扁平控制器
#define INVTEMP_TYPE     3                          //!< 逆变器温度采集 1：NTC473电路1 2:NTC473电路2 3:IGBT壳温（1。0倍） 4：IGBT壳温（1.5倍）
#define MOTTEMPTYPE      3                          //!< 电机温度采集  1：PT100电路1 2：PT100d电路2
#if  USE_4C == 1
...
#define VOLTBUS_RANGE    9220                       //!< 母线电压满量程范围     0.1V 可配置
#define VOLTCAP_RANGE    9220                       //!< 电容电压满量程范围     0.1V 可配置
...
#define M1_I2C_SDA_GPIO  GPIO_Number_32                     //!< I2C_SDA GPIO
#define M1_I2C_SCL_GPIO  GPIO_Number_33                     //!< I2C_SCL GPIO
#define M1_I2C_SDA_MODE  GPIO_32_Mode_SDDA                  //!< GPIO模式
#define M1_I2C_SCL_MODE  GPIO_33_Mode_SCLA                  //!< GPIO模式
...
#define HAL_Pwm_BUF2_En(halHandle)       GPIO_setHigh(halHandle->gpioHandle,GPIO_Number_10)
#define HAL_Pwm_BUF2_Dis(halHandle)      GPIO_setLow(halHandle->gpioHandle,GPIO_Number_10)

#define HAL_Pwm_POWER_En(halHandle)      GPIO_setHigh(halHandle->gpioHandle,GPIO_Number_26)
#define HAL_Pwm_POWER_Dis(halHandle)     GPIO_setLow(halHandle->gpioHandle,GPIO_Number_26)

#define HAL_Pwm_ShutDown_En(halHandle)   GPIO_setLow(halHandle->gpioHandle,GPIO_Number_27)
#define HAL_Pwm_ShutDown_Dis(halHandle)  GPIO_setHigh(halHandle->gpioHandle,GPIO_Number_27)  //!< 正常工作时Dis
...
#define HAL_DRV1_En(halHandle)           GPIO_setHigh(halHandle->gpioHandle,GPIO_Number_51)  //!< 主接触器控制
#define HAL_DRV1_Dis(halHandle)          GPIO_setLow(halHandle->gpioHandle,GPIO_Number_51)

#define HAL_DRV2_En(halHandle)           GPIO_setHigh(halHandle->gpioHandle,GPIO_Number_29)  //!< 预充接触器控制
#define HAL_DRV2_Dis(halHandle)          GPIO_setLow(halHandle->gpioHandle,GPIO_Number_29)
...
#define HAL_KEEP_POWER_En(halHandle)      GPIO_setHigh(halHandle->gpioHandle,GPIO_Number_16)
#define HAL_KEEP_POWER_Dis(halHandle)     GPIO_setLow(halHandle->gpioHandle,GPIO_Number_16)

#define HAL_KSI_SW(halHandle)            (!GPIO_read(halHandle->gpioHandle,GPIO_Number_44))
#define HAL_Coder_Err(halHandle)         GPIO_read(halHandle->gpioHandle,GPIO_Number_28)
#define HAL_Pwm_Fault1(halHandle)        (!GPIO_read(halHandle->gpioHandle,GPIO_Number_39))
#define HAL_Pwm_Fault2(halHandle)        (!GPIO_read(halHandle->gpioHandle,GPIO_Number_53))
#define HAL_Pwm_Fault3(halHandle)        (!GPIO_read(halHandle->gpioHandle,GPIO_Number_54))
#define HAL_DRV1_ST(halHandle)           (!GPIO_read(halHandle->gpioHandle,GPIO_Number_12))
#define HAL_DRV2_ST(halHandle)           (!GPIO_read(halHandle->gpioHandle,GPIO_Number_50))

#define HAL_SW1_IN(halHandle)            (!GPIO_read(halHandle->gpioHandle,GPIO_Number_20))
#define HAL_SW2_IN(halHandle)            (!GPIO_read(halHandle->gpioHandle,GPIO_Number_21))
#define HAL_SW3_IN(halHandle)            (!GPIO_read(halHandle->gpioHandle,GPIO_Number_42))
#define HAL_SW4_IN(halHandle)            (!GPIO_read(halHandle->gpioHandle,GPIO_Number_23))
