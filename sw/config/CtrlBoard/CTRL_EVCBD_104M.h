// ================================================================================================
//! \file       CTRL_EVCBD_104M.h
//! \brief      控制器EVCBD_104M原理图
//! \author     sunyanjun
//! \version    1.0.0
//! \date       2017年4月12日
//! \copyright  SANTROLL.
...
#ifndef _CTRL_EVCBD_104M_H_
#define _CTRL_EVCBD_104M_H_

//! @defgroup CTRL_EVCBD_104M
//! @{
...
#define INVTEMP_TYPE     1                          //!< 逆变器温度采集 1：NTC473电路1 2:NTC473电路2 3:IGBT壳温（1。0倍） 4：IGBT壳温（1.5倍）
#define MOTTEMPTYPE      1                          //!< 电机温度采集  1：PT100电路1 2：PT100d电路2
#define CUR_SEN_TYPE     CUR_SEN_mnusU_noneV_mnusW  //!< 电流传感器类型[-U    -W]
#define CUR_RANGE        15994                      //!< 电流传感器满量程范围 0.1A ==> 200S
#define CURBUS_RANGE     0                          //!< 母线电流传感器满量程范围  0=没有母线电流传感器
#define VOLTBUS_RANGE    9063                       //!< 母线电压满量程范围     0.1V 可配置
#define VOLTCAP_RANGE    9063                       //!< 电容电压满量程范围     0.1V 可配置
#define VOLT_MAX         4800                       //!< 控制器最大电压              0.1V
...
#define M1_TEMP_INV3    ADC_readResult(halHandle->adcHandle,ADC_ResultNumber_10)
...
//! @} // end of CTRL_EVCBD_104M

#endif // end of _CTRL_EVCBD_104M_H_
