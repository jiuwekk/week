...
// ================================================================================================
// the defines
#define INVTEMP_TYPE     5                          //!< 逆变器温度采集 1：NTC473电路1 2:NTC473电路2 3:IGBT壳温（1。0倍） 4：IGBT壳温（1.5倍）;5:05XB
...
//3.逻辑电压
#define M1_VOLT_05V     ADC_readResult(halHandle->adcHandle,ADC_ResultNumber_14)//(4096)  //!< 信号缺失时，设定值为4096，防止误报故障
#define M1_VOLT_12V     ADC_readResult(halHandle->adcHandle,ADC_ResultNumber_15)//(4096)  //!< 信号缺失时，设定值为4096，防止误报故障
#define M1_VOLT_24V     ADC_readResult(halHandle->adcHandle,ADC_ResultNumber_10)//(4096)  //!< 信号缺失时，设定值为4096，防止误报故障
...
#define M1_VOLT_POT1    ADC_readResult(halHandle->adcHandle,ADC_ResultNumber_3)
#define M1_VOLT_POT2    ADC_readResult(halHandle->adcHandle,ADC_ResultNumber_4)
#define M1_VOLT_POT3    ADC_readResult(halHandle->adcHandle,ADC_ResultNumber_5)
...
#define HAL_DRV2_En(halHandle)            GPIO_setHigh(halHandle->gpioHandle,GPIO_Number_53) // 预充接触器
...
//KSI_TEST 钥匙 输入状态
#define HAL_KSI_SW(halHandle)             (GPIO_read(halHandle->gpioHandle,GPIO_Number_43))
