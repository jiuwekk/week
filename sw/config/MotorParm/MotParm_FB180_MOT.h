...
#ifndef SW_CONFIG_MotParm_FB180_MOT_H_
#define SW_CONFIG_MotParm_FB180_MOT_H_
...
#define ELECZERO            2730//2730//641       //!< 电机旋变零点
#define CURBASE             (3200 * SQRT2)//!< 电流基值(峰值)*0.1A
#define VOLTBASE            3200       //!< 电压基值*0.1V   不改
...
#define PWM_LOW_FREQ        4800       //!< 低频，2K
...
#define KP_IQ               1300       //!< Q轴Kp参数*0.001
#define KI_IQ               2000       //!< Q轴Ki参数*0.0001
#define KP_FW1              250        //!< IdWeak_Kp参数*0.001
#define KI_FW1              58         //!< IdWeak_Ki参数*0.0001
#if 1
    #define KP_FW2              15000      //!< AngleWeak_Kp参数*0.01
    #define KI_FW2              500        //!< AngleWeak_Ki参数*0.01
#else
    #define KP_FW2              300      //!< AngleWeak_Kp参数*0.001
    #define KI_FW2              5000     //!< AngleWeak_Ki参数*0.0001
#endif
...
#define DCOVERVOLT3         4200       //!< 电压过压3 0.1V
#define DCOVERVOLT2         4100       //!< 电压过压2 0.1V
#define DCOVERVOLT1         4000       //!< 电压过压1 0.1V
#define DCUNDERVOLT1        500       //!< 电压欠压1 0.1V
#define DCUNDERVOLT2        500       //!< 电压欠压2 0.1V
