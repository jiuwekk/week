/*
 * MotParm_SUNCAR_155.h
 *
 *  Created on: 2021年9月29日
 *      Author: P783
 */

#ifndef SW_CONFIG_MotParm_SUNCAR_155_MOT_H_
#define SW_CONFIG_MotParm_SUNCAR_155_MOT_H_
...
#define ELECZERO            1659       //!< 电机旋变零点     2300转
#define SWAPENCODERDIR      0          //!< 旋变方向换向
#define SWAPPHASE           1          //!< 电机相线换向
#define CURBASE             (3100 * SQRT2)//!< 电流基值(峰值)*0.1A
...
#define PWM_LOW_FREQ        4200       //!< 低频，2K
#define PWM_HIGH_FREQ       4200       //!< 高频，5k 高低相等不变频
#define PWM_LOW_FREQ_HZ     2          //!< 低频，电机Hz
#define PWM_HIGH_FREQ_HZ    10         //!< 高频，电机Hz 高低相等不变频

#define KP_ID               600//1500       //!< D轴Kp参数*0.001
#define KI_ID               200        //!< D轴Ki参数*0.0001
#define KP_IQ               600//1500       //!< Q轴Kp参数*0.001
...
#define DCOVERVOLT3         3000       //!< 电压过压3 0.1V
#define DCOVERVOLT2         2800       //!< 电压过压2 0.1V
#define DCOVERVOLT1         2500       //!< 电压过压1 0.1V
#define DCUNDERVOLT1        1000       //!< 电压欠压1 0.1V
#define DCUNDERVOLT2         700       //!< 电压欠压2 0.1V
...
#define KP_SPDM0            7000       //!< 速度模式0Kp参数*0.001
#define KI_SPDM0            300        //!< 速度模式0Ki参数*0.0001
