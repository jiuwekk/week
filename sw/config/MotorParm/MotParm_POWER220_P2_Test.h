...
#ifndef SW_CONFIG_MOTPARM_POWER220_P2_TEST_H_
#define SW_CONFIG_MOTPARM_POWER220_P2_TEST_H_
...
#define ELECZERO            641       //!< 电机旋变零点
#define CURBASE             (3700 * SQRT2)//!< 电流基值(峰值)*0.1A
#define VOLTBASE            3000       //!< 电压基值*0.1V   不改
...
#define ACOVERCUR1          6000       //!< 相线过流1 0.1A(峰值)
#define ACOVERCUR2          7500       //!< 相线过流2 0.1A(峰值)
#define DCOVERVOLT3         7000       //!< 电压过压3 0.1V
#define DCOVERVOLT2         6500       //!< 电压过压2 0.1V
