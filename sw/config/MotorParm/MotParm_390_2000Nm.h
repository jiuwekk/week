/*
 * MotParm_390_2000Nm.h
 *
 *  Created on: 2022年8月15日
 *      Author: liuxujie
 */

#ifndef SW_CONFIG_MOTORPARM_MOTPARM_390_2000NM_H_
#define SW_CONFIG_MOTORPARM_MOTPARM_390_2000NM_H_

#define ELECZERO            867              //!< 电机旋变零点
#define CURBASE             (3700 * SQRT2)  //!< 电流基值(峰值)*0.1A
#define VOLTBASE            5400            //!< 电压基值*0.1V   不改
...
#define KP_ID               1200        //!< D轴Kp参数*0.001
#define KI_ID               100        //!< D轴Ki参数*0.0001
#define KP_IQ               3000        //!< Q轴Kp参数*0.001
#define KI_IQ               100        //!< Q轴Ki参数*0.0001
#define KP_FW1              100        //!< IdWeak_Kp参数*0.001
#define KI_FW1              3000         //!< IdWeak_Ki参数*0.0001
...
#define ACOVERCUR1          4500       //!< 相线过流1 0.1A(峰值)
#define ACOVERCUR2          5200       //!< 相线过流2 0.1A(峰值)
...
#endif /* SW_CONFIG_MOTORPARM_MOTPARM_390_2000NM_H_ */
