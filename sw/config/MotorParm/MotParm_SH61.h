...
#ifndef SW_CONFIG_MOTORPARM_MOTPARM_SH61_H_
#define SW_CONFIG_MOTORPARM_MOTPARM_SH61_H_

#define ELECZERO            22              //!< 电机旋变零点
#define CURBASE             (1650 * SQRT2)  //!< 电流基值(峰值)*0.1A
#define VOLTBASE            6000            //!< 电压基值*0.1V   不改
...
#define KP_ID               300        //!< D轴Kp参数*0.001
#define KI_ID               500        //!< D轴Ki参数*0.0001
...
#define DCOVERVOLT3         7500       //!< 电压过压3 0.1V
#define DCOVERVOLT2         7000       //!< 电压过压2 0.1V
#define DCOVERVOLT1         6500       //!< 电压过压1 0.1V
...
#endif /* SW_CONFIG_MOTORPARM_MOTPARM_SH61_H_ */
