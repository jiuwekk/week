...
#ifndef SW_CONFIG_MOTPARM_SH86125A_H_
#define SW_CONFIG_MOTPARM_SH125A_H_


#define ELECZERO            14             //!< 电机旋变零点
#define CURBASE             (1250 * SQRT2)   //!< 电流基值(峰值)*0.1A
#define VOLTBASE            8000            //!< 电压基值*0.1V   不改
#define SPEEDBASE           10000           //!< 转速基值
#define IF                  2780            //!< 等效励磁电流*0.1A
#define BEMF                1100            //!< 1000rpm反电势对应的电压 *0.1V
#define MOTPOLEPAIRS        16               //!< 电机极对数#
#define ENCODERPOLEPAIRS    2               //!< 旋变极对数#
...
#define PWM_LOW_FREQ        10500       //!< 低频，2K
#define PWM_HIGH_FREQ       10500       //!< 高频，5k 高低相等不变频
#define PWM_LOW_FREQ_HZ     2          //!< 低频，电机Hz
#define PWM_HIGH_FREQ_HZ    10         //!< 高频，电机Hz 高低相等不变频

#define KP_ID               1300       //!< D轴Kp参数*0.001
#define KI_ID               3000        //!< D轴Ki参数*0.0001
...
#define DCOVERCUR           2000       //!< 母线过流       0.1A
#define ACOVERCUR1          3000       //!< 相线过流1 0.1A(峰值)
#define ACOVERCUR2          4000       //!< 相线过流2 0.1A(峰值)
#define DCOVERVOLT3         6200       //!< 电压过压3 0.1V
#define DCOVERVOLT2         6100       //!< 电压过压2 0.1V
#define DCOVERVOLT1         6000       //!< 电压过压1 0.1V
#define DCUNDERVOLT1        2000       //!< 电压欠压1 0.1V
#define DCUNDERVOLT2        1000       //!< 电压欠压2 0.1V
#define DCUNDERVOLT3        500       //!< 电压欠压3 0.1V
...
#endif /* SW_CONFIG_MOTPARM_SH86125A_H_ */
