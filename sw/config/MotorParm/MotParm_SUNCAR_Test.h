...
#ifndef SW_CONFIG_MotParm_SUNCAR_Test_H_
#define SW_CONFIG_MotParm_SUNCAR_Test_H_
...
#define ELECZERO            3460//3722//2781       //!< 电机旋变零点，3722是车上的;2781是家里测试的
#define CURBASE             (3600 * SQRT2)//!< 电流基值(峰值)*0.1A       电机约束的有效值，上位机会显示峰值
#define VOLTBASE            1440//850       //!< 电压基值*0.1V
...
#define SWAPENCODERDIR      1//0//1          //!< 旋变方向换向
#define SWAPPHASE           1//0          //!< 电机相线换向
...
#define PWM_LOW_FREQ        6000       //!< 低频，2K
#define PWM_HIGH_FREQ       6000       //!< 高频，5k 高低相等不变频
#define PWM_LOW_FREQ_HZ     2          //!< 低频，电机Hz
#define PWM_HIGH_FREQ_HZ    10         //!< 高频，电机Hz 高低相等不变频

#define KP_ID               1700       //!< D轴Kp参数*0.001
#define KI_ID               200        //!< D轴Ki参数*0.0001
#define KP_IQ               1700       //!< Q轴Kp参数*0.001
#define KI_IQ               200        //!< Q轴Ki参数*0.0001
#define KP_FW1              250        //!< IdWeak_Kp参数*0.001
#define KI_FW1              58         //!< IdWeak_Ki参数*0.0001
#define KP_FW2              23000         //!< AngleWeak_Kp参数*0.01
#define KI_FW2              500         //!< AngleWeak_Ki参数*0.01
#define FW1_REF             1.05       //!< IdWeak参考      过调制
#define FW2_REF             1.05       //!< AngleWeak参考     过调制
#define UDMAX               1.4        //!< D轴电压最大值
#define UQMAX               1.4        //!< Q轴电压最大值

#define DCOVERCUR           5500       //!< 母线过流       0.1A
#define ACOVERCUR1          6100//5500       //!< 相线过流1 0.1A(峰值)
#define ACOVERCUR2          6600//5500       //!< 相线过流2 0.1A(峰值)
#define DCOVERVOLT3         2000       //!< 电压过压3 0.1V
#define DCOVERVOLT2         1900       //!< 电压过压2 0.1V
#define DCOVERVOLT1         1800       //!< 电压过压1 0.1V
#define DCUNDERVOLT1        500        //!< 电压欠压1 0.1V
#define DCUNDERVOLT2        400        //!< 电压欠压2 0.1V
#define DCUNDERVOLT3        300        //!< 电压欠压3 0.1V

#define OVERSPD1            6000       //!< 超速1转速
#define OVERSPD2            6500       //!< 超速2转速
...
#define TABNREFU            800       //!< 测定特性表时的电压0.1V
#define TABNREFCUR     (1200 * SQRT2)  //!< 测点特性表时的电流0.1A
